...
const schema = {
  ...
  properties: {
    ...
    consulta: { type: "STRING", enum: ["resumen", "deuda", "saldo", "fondo", "objetivos", "deudas", "prevision", "casa", "patrimonio", "amortizacion", "categorias", "gastos"] },
...
- "consulta": pregunta por el estado:
  ...
  · "gastos" = cuánto ha gastado cada uno este mes (por persona).
