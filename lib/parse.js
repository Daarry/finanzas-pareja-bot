...
export const CATEGORIAS = [
  ...
  "Alquiler/Hipoteca", "Luz", "Agua", "Gas", "Internet/Móvil", "Comunidad", "Seguros", "Hogar",
  "Supermercado", "Transporte/Gasolina", "Salud", "Ocio", "Ropa", "Mascotas",
  "Suscripciones", "Gimnasio", "Préstamo personal", "Bizum", "Impuestos/Tasas", "Cuidado personal", "Ahorro", "Préstamo mamá", "Otros",
];
...
- Hogar: menaje, muebles, electrodomésticos, ventilador, bombillas, arreglos de casa, ferretería, bricolaje, decoración.
...
- Ahorro: traspaso a tu cuenta/hucha de ahorro propia (ahorro, hucha, meter en ahorro, apartar a ahorro). Tipo = "Personal" (no cuenta como gasto común).
- Préstamo mamá: el préstamo del coche que está a tu nombre pero es de tu madre. DOS movimientos posibles, misma categoría: cuando TE COBRAN la cuota (tipo "Fijo personal") y cuando ELLA TE INGRESA el importe correspondiente (tipo "Ingreso"). No confundir con "Préstamo personal" (deudas tuyas de verdad).
...
"meto 100 en el ahorro" -> {"intent":"registrar","tipo":"Personal","categoria":"Ahorro","concepto":"Traspaso ahorro","importe":100}
"traspaso 50 a mi hucha" -> {"intent":"registrar","tipo":"Personal","categoria":"Ahorro","concepto":"Traspaso ahorro","importe":50}
"me han cobrado 254,99 del préstamo del coche de mamá" -> {"intent":"registrar","tipo":"Fijo personal","categoria":"Préstamo mamá","concepto":"Cuota préstamo coche mamá","importe":254.99}
"mamá me ha ingresado 254,99 del préstamo del coche" -> {"intent":"registrar","tipo":"Ingreso","categoria":"Préstamo mamá","concepto":"Ingreso préstamo coche mamá","importe":254.99}
...
"borra el movimiento de 1,45" -> {"intent":"borrar","importe":1.45}
"elimina el gasto de 20 de la peluquería" -> {"intent":"borrar","importe":20,"concepto":"peluquería"}
